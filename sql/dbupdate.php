...
<?php
	...
	$ilDB->query("INSERT INTO `rep_robj_xpdl_adm_set` (epkey, epvalue) SELECT 'author_identification_conf_readonly_if_missing_value',true FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM rep_robj_xpdl_adm_set WHERE epkey = 'author_identification_conf_readonly_if_missing_value');");
