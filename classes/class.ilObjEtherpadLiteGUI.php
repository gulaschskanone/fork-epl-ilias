...
//
    ...
    function showContent()
    {
        ...
        try
        {
			...
			elseif($this->adminSettings->getValue("author_identification_conf"))
			{
				...
				if($this->adminSettings->getValue("author_identification_conf_readonly_if_missing_value"))
				{
					$padID = $this->object->getReadOnlyID();
				}
			}
    ...
    /*
    // hint while creation of a new pad. Not realy necessary. 
    ...
    // de.lang
    // info_author_identification#:#HINWEIS: Die Autoren schreiben in der Standardeinstellung unter ihrem vollständigen Namen. 
	// info_author_identification_selectable#:#Dies kann in den Einstellungen auf der folgenden Seite geändert werden.
	
	// en.lang
	// info_author_identification#:#NOTE: Participants write under their full name by default.
	// info_author_identification_selectable#:#This can be changed in the pad settings on the following page.
    */
